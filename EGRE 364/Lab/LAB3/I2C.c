...
void I2C_GPIO_init(void){
	...
	// GPIO Mode Register
	I2C_PORT->MODER   &= ~0xF0000;  // Clear bits
	I2C_PORT->MODER   |= 0xA0000;  // Alternate Function Mode
	
	// Alternate function selection register
	I2C_PORT->AFR[1]  &=~0xFF;   // Alternate Function 4 = I2C1
	I2C_PORT->AFR[1]  |=0x44;   // Alternate Function 4 = I2C1
	
	// GPIO Speed Register
	I2C_PORT->OSPEEDR &= ~0xF0000;   // Clear bits
	I2C_PORT->OSPEEDR |= 0xA0000;   // High Speed
	
	// GPIO Push-Pull Register
	I2C_PORT->PUPDR   &= ~0xF0000;   // Clear bits
	I2C_PORT->PUPDR   |= 0x50000;   // Pull-up
	
	// GPIO Output Type Register
	I2C_PORT->OTYPER &= ~0x300;
	I2C_PORT->OTYPER  |= 0x300;   // Open-Drain 
}
